  ...
  return (
    ...
    >
      <div className="relative h-60 w-full">
        ...
        />
        {featured && (
          <div className="absolute top-4 right-4 bg-gradient-primary text-light px-3 py-1 rounded-full text-sm font-semibold z-10">
            Featured
          </div>
        )}
      ...
      <div className="p-6 flex flex-col flex-grow">
        ...
        <div className="flex justify-between items-center mt-auto pt-4 border-t border-dark-light/10">
          ...
          <Link
            ...
            className="bg-gradient-primary hover:opacity-90 text-light px-4 py-2 rounded-md transition-all transform hover:scale-105 active:scale-95"
          >
            View Details
          </Link>
        </div>
